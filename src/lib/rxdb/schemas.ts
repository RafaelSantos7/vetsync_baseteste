...
function base<T extends Record<string, any>>(
  ...
  return {
    ...
    properties: {
      ...
      organization_id: { type: ["string", "null"], maxLength: 64 },
...
const jsonArr = { type: ["array", "null"], items: { type: "object", additionalProperties: true } } as const;

export const SCHEMAS = {
  clients: base({
    name: { type: "string", maxLength: 200 },
    document: str, phone: str, whatsapp: str, email: str,
    address: str, city: str, notes: str,
  }, ["name"], [["name"]]),

  pets: base({
    client_id: { type: "string", maxLength: 64 },
    name: { type: "string", maxLength: 200 },
    species: str, breed: str, sex: str, birth_date: str,
    weight: num, color: str, neutered: bool,
    allergies: str, diseases: str, medications: str,
    photo_urls: strArr,
  }, ["client_id", "name"], [["name"], ["client_id"]]),

  appointments: base({
    client_id: str, pet_id: str,
    title: { type: "string", maxLength: 200 },
    category: { type: "string", maxLength: 50 },
    scheduled_at: { type: "string", maxLength: 40 },
    duration_min: num, status: str, notes: str,
    google_event_id: str,
    last_synced_at: str,
  }, ["title", "category", "scheduled_at"], [["scheduled_at"]]),

  medical_records: base({
    pet_id: { type: "string", maxLength: 64 },
    client_id: str,
    appointment_date: { type: "string", maxLength: 40 },
    weight: num, temperature: num,
    anamnesis: str, symptoms: str, diagnosis: str,
    prescription: str, observations: str,
    notes: str,
    signature_url: str,
    attachments: jsonArr,
  }, ["pet_id", "appointment_date"], [["pet_id"], ["appointment_date"]]),

  vaccines: base({
    pet_id: { type: "string", maxLength: 64 },
    name: { type: "string", maxLength: 200 },
    applied_at: { type: "string", maxLength: 20 },
    next_due: str, notes: str,
  }, ["pet_id", "name", "applied_at"], [["pet_id"], ["applied_at"]]),
  ...
  financial_transactions: base({
    ...
    amount: { type: "number" },
    due_date: str, paid_at: str, payment_method: str, notes: str,
  ...
  herd_animals: base({
    ...
    notes: str,
  }, ["property_id", "identification", "status"], [["property_id"]]),
  ...
  }, ["property_id", "scheduled_at"], [["property_id"], ["scheduled_at"]]),
  ...
  odontogram_teeth: base({
    ...
    status: str, procedure: str, notes: str,
    images: strArr,
  }, ["odontogram_id", "tooth_number"], [["odontogram_id"]]),
